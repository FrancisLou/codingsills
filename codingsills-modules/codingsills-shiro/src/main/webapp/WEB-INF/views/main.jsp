    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li><a href="#">信箱</a></li>
                                <li class="divider"></li>
                                <li><a href="${ctx}/logout.t">安全退出</a></li>
                            </ul>
                        </div>
        ...
        <div id="page-wrapper" class="gray-bg">
	        ...
	        <div class="row border-bottom white-bg dashboard-header">
	        	<iframe id="main_frame" name="iframe0" width="100%" height="100%" src="" frameborder="0" seamless></iframe>
	        </div>
           <div class="footer">
               <div class="pull-right">
                   <strong>Copyright</strong> MPLUS Company &copy; 2015-2016
               </div>
           </div>
        </div>
        <!-- 右侧边栏开始 -->
