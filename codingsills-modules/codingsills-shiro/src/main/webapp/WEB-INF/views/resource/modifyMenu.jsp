...
<body class="white-bg">
	<form class="form-horizontal" action="${ctx}/resource/modifyMenu" method="post">
	  <div class="form-group" hidden>
	    <label for="menu_Id" class="col-sm-2 control-label">菜单ID</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="id" value="${menu.id}" id="menu_Id" placeholder="菜单ID">
	    </div>
	  </div>
	  <div class="form-group" hidden>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="text" name="name" value="${menu.name}" class="form-control" id="menu_name" placeholder="菜单名称">
	    </div>
	  </div>
	  <div class="form-group">
	    <label for="menu_link" class="col-sm-2 control-label">菜单路径</label>
	    <div class="col-sm-10">
	      <input type="text" class="form-control" name="url" value="${menu.url}" id="menu_link" placeholder="菜单路径">
	    </div>
	  </div>
	  <div class="form-group">
