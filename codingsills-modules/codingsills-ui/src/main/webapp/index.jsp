    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="${ctx}/static/images/profile_small.jpg" /></span>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${ctx}/pages/home/index_v1.jsp" data-index="0">主页示例一</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${ctx}/pages/home/index_v2.jsp">主页示例二</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${ctx}/pages/home/index_v3.jsp">主页示例三</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${ctx}/pages/home/index_v4.jsp">主页示例四</a>
                            </li>
                            <li>
                                <a href="${ctx}/pages/home/index_v5.jsp" target="_blank">主页示例五</a>
                            </li>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="${ctx}/pages/home/index_v1.jsp">首页</a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${ctx}/pages/home/index_v1.jsp?v=4.0" frameborder="0" data-id="${ctx}/pages/home/index_v1.jsp" seamless></iframe>
            </div>
            <div class="footer">
