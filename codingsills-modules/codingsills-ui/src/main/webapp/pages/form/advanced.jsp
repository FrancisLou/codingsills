...
<head>
    ...
    <link href="${ctx}/static/plugins/nouslider/jquery.nouislider.css" rel="stylesheet" type="text/css" >
    <link href="${ctx}/static/plugins/datepicker/datepicker3.css" rel="stylesheet" type="text/css" >
    <link href="${ctx}/static/plugins/ionRangeSlider/ion.rangeSlider.css" rel="stylesheet" type="text/css" >
    <link href="${ctx}/static/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css" rel="stylesheet" type="text/css" >
    <link href="${ctx}/static/css/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet" type="text/css" >
    <link href="${ctx}/static/plugins/clockpicker/clockpicker.css" rel="stylesheet" type="text/css" >
	<link href="${ctx}/static/plugins/iCheck/icheck.css" rel="stylesheet" type="text/css" />
</head>
<body class="gray-bg">
    ...
    <script src="${ctx}/static/plugins/chosen/chosen.jquery.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/jsKnob/jquery.knob.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/jasny/jasny-bootstrap.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/prettyfile/bootstrap-prettyfile.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/nouslider/jquery.nouislider.min.js" type="text/javascript" ></script>
