...
<body class="gray-bg">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="m-t m-b">
                            ...
                            <div id="userAlbums" style="display:none">
                                <a href="${ctx}/static/images/a1.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a1.jpg" alt="示例图片1" />
                                </a>
                                <a href="${ctx}/static/images/a2.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a2.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a3.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a3.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a4.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a4.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a5.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a5.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a6.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a6.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a7.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a7.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a8.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a8.jpg" alt="示例图片2" />
                                </a>
                                <a href="${ctx}/static/images/a9.jpg" class="fancybox" title="选取该照片">
                                    <img src="${ctx}/static/images/a9.jpg" alt="示例图片2" />
                                </a>
                            </div>
                        </div>
    ...
    <script src="${ctx}/static/plugins/fullavatareditor/swfobject.js" type="text/javascript" ></script>
	<script src="${ctx}/static/plugins/fullavatareditor/fullAvatarEditor.js" type="text/javascript" ></script>
	<script src="${ctx}/static/plugins/fullavatareditor/jQuery.Cookie.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/fullavatareditor/test.js" type="text/javascript" ></script>
</body>
