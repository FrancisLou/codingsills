...
<body class="gray-bg">
	...
	<script src="${ctx}/static/plugins/summernote/summernote.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/summernote/summernote-zh-CN.js" type="text/javascript" ></script>
	<script>
