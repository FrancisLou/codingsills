...
<body class="gray-bg">
    ...
    <script src="${ctx}/static/plugins/simditor/module.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/simditor/uploader.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/simditor/hotkeys.min.js" type="text/javascript" ></script>
	<script src="${ctx}/static/plugins/simditor/simditor.min.js" type="text/javascript" ></script>
	<script>
