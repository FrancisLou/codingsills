...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/static/plugins/summernote/summernote.css" />
	<link rel="stylesheet" type="text/css" href="${ctx}/static/plugins/summernote/summernote-bs3.css" />
</head>
<body class="gray-bg">
