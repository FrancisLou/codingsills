...
<body class="gray-bg">
    ...
    <script type="text/javascript" src="${ctx}/static/plugins/validate/jquery.validate.min.js"></script>
	<script type="text/javascript" src="${ctx}/static/plugins/validate/messages_zh.min.js"></script>
	<script type="text/javascript" src="${ctx}/static/demo/form-validate-demo.min.js"></script>
</body>
