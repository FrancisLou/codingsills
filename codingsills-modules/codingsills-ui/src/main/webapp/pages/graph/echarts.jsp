...
<body class="gray-bg">
    ...
    <script src="${ctx}/static/plugins/echarts/map/china.js" type="text/javascript" ></script>
    <script src="${ctx}/static/demo/echarts-demo.min.js" type="text/javascript" ></script>
</body>
