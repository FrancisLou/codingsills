...
<body class="gray-bg">
    ...
    <script src="${ctx}/static/plugins/peity/jquery.peity.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/demo/peity-demo.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript" ></script>
    <script src="${ctx}/static/demo/sparkline-demo.min.js" type="text/javascript" ></script>
	<script>
