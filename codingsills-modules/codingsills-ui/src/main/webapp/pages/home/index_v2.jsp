...
<head>
   ...
   <%--  <link rel="stylesheet" type="text/css" href="${ctx}/static/plugins/morris/morris.css" /> --%>
	<link rel="stylesheet" type="text/css" href="${ctx}/static/plugins/gritter/jquery.gritter.css" />
</head>
...
<body class="gray-bg">
    ...
    <script src="${ctx}/static/plugins/flot/jquery.flot.js"></script>
    <script src="${ctx}/static/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${ctx}/static/plugins/flot/jquery.flot.spline.js"></script>
    <script src="${ctx}/static/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${ctx}/static/plugins/flot/jquery.flot.pie.js"></script>
    ...
    <script src="${ctx}/static/plugins/gritter/jquery.gritter.min.js"></script>
    <script src="${ctx}/static/plugins/easypiechart/jquery.easypiechart.js"></script>
    <script src="${ctx}/static/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="${ctx}/static/demo/sparkline-demo.min.js"></script>
    <script>
