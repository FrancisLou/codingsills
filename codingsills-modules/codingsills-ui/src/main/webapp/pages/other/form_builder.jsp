...
<head>
    ...
    <link href="${ctx}/static/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="${ctx}/static/plugins/summernote/summernote-bs3.css" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="${ctx}/static/plugins/beautifyhtml/beautifyhtml.js"></script>
    <script>
