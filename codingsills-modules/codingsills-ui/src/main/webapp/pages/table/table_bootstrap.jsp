...
<body class="gray-bg">
            ...
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-6">
                        ...
                        <div class="example">
                            <table data-toggle="table" data-url="${ctx}/static/demo/table_base.json" data-height="250" data-mobile-responsive="true">
                                <thead>
                                    <tr>
                ...
                <div class="row row-lg">
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-classes="table table-hover table-condensed" data-url="${ctx}/static/demo/table_base.json" data-striped="true" data-height="250" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            <th data-field="Tid">ID</th>
                                            <th data-field="First">姓名</th>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/bootstrap_table_test2.json" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap margin-sm-0">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/table_base.json" data-mobile-responsive="true" data-row-style="rowStyle" data-height="250">
                                    <thead>
                                        <tr>
                                            <th data-field="Tid">ID</th>
                                            <th data-field="First">姓名</th>
                ...
                <div class="row row-lg">
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/table_base.json" data-height="250" data-sort-name="First" data-sort-order="desc" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/table_base.json" data-height="250" data-sort-name="Score" data-sort-order="desc" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/table_base.json" data-height="250" data-show-header="false" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            <th data-field="Tid">ID</th>
                                            <th data-field="First">姓名</th>
                ...
                <div class="row row-lg">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap margin-sm-0">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/bootstrap_table_test.json" data-height="299" data-click-to-select="true" data-select-item-name="myRadioName" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            <th data-field="state" data-radio="true"></th>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/bootstrap_table_test.json" data-height="299" data-click-to-select="true" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                ...
                <div class="row row-lg">
                    <div class="col-sm-12">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table data-toggle="table" data-url="${ctx}/static/demo/bootstrap_table_test2.json" data-card-view="true" data-mobile-responsive="true">
                                    <thead>
                                        <tr>
                                            <th data-field="name">名称</th>
                                            <th data-field="star">Star</th>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="example">
                                <table id="exampleTablePagination" data-toggle="table" data-url="${ctx}/static/demo/bootstrap_table_test.json" data-query-params="queryParams" data-mobile-responsive="true" data-height="400" data-pagination="true" data-icon-size="outline" data-search="true">
                                    <thead>
                                        <tr>
                                            <th data-field="state" data-checkbox="true"></th>
    ...
    <script src="${ctx}/static/plugins/bootstrap-table/bootstrap-table-mobile.min.js"></script>
    <script src="${ctx}/static/plugins/bootstrap-table/bootstrap-table-zh-CN.min.js"></script>
    <script src="${ctx}/static/demo/bootstrap-table-demo.min.js"></script>
</body>
