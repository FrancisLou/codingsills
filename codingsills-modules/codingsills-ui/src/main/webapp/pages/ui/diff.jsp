...
“百度新闻”是包含海量资讯的新闻服务性质的新闻平台，真实反映新闻热点。您可以搜索新闻事件、热点话题、人物动态、资讯等，快速了解它们的最新进展。
    ...
    <script src="${ctx}/static/plugins/diff_match_patch/diff_match_patch.js"></script>
    <script src="${ctx}/static/plugins/preetyTextDiff/jquery.pretty-text-diff.min.js"></script>
    <script>
