                            ...
                            <div class="col-md-9 ">
                                <div class="chat-discussion">
                                    ...
                                    <div class="chat-message">
                                        <img class="message-avatar" src="${ctx}/static/images/a1.jpg" alt="">
                                        <div class="message">
                                    ...
                                    <div class="chat-message">
                                        <img class="message-avatar" src="${ctx}/static/images/a4.jpg" alt="">
                                        <div class="message">
                                    ...
                                    <div class="chat-message">
                                        <img class="message-avatar" src="${ctx}/static/images/a2.jpg" alt="">
                                        <div class="message">
                                    ...
                                    <div class="chat-message">
                                        <img class="message-avatar" src="${ctx}/static/images/a5.jpg" alt="">
                                        <div class="message">
                                            <a class="message-author" href="#"> 林依晨Ariel </a>
                                            <span class="message-date">  2015-02-02 - 11:12:36 </span>
                                            <span class="message-content">
                                    ...
                                    <div class="chat-message">
                                        <img class="message-avatar" src="${ctx}/static/images/a6.jpg" alt="">
                                        <div class="message">
                                            <a class="message-author" href="#"> 林依晨Ariel </a>
                                            <span class="message-date">  2015-02-02 11:12:36 </span>
                                            <span class="message-content">
                            ...
                            <div class="col-md-3">
                                <div class="chat-users">
                                    ...
                                    <div class="users-list">
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="${ctx}/static/images/a4.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="#">伤城Simple</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="${ctx}/static/images/a1.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="#">从未出现过的风景__</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            ...
                                            <img class="chat-avatar" src="${ctx}/static/images/a2.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="#">冬伴花暖</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <span class="pull-right label label-primary">在线</span>
                                            <img class="chat-avatar" src="${ctx}/static/images/a3.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="#">ZM敏姑娘	</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="${ctx}/static/images/a5.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="#">才越越</a>
                                            </div>
                                        </div>
                                        <div class="chat-user">
                                            <img class="chat-avatar" src="${ctx}/static/images/a6.jpg" alt="">
                                            <div class="chat-user-name">
                                                <a href="#">时光十年TENSHI</a>
                                            </div>
                                        </div>
