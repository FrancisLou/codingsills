        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="${ctx}/pages/view/profile.jsp">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="${ctx}/static/images/a2.jpg">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="${ctx}/pages/view/profile.jsp">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="${ctx}/static/images/a1.jpg">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="${ctx}/pages/view/profile.jsp">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="${ctx}/static/images/a3.jpg">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="${ctx}/pages/view/profile.jsp">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="${ctx}/static/images/a4.jpg">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="${ctx}/pages/view/profile.jsp">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="${ctx}/static/images/a5.jpg">
            ...
            <div class="col-sm-4">
                <div class="contact-box">
                    <a href="${ctx}/pages/view/profile.jsp">
                        <div class="col-sm-4">
                            <div class="text-center">
                                <img alt="image" class="img-circle m-t-xs img-responsive" src="${ctx}/static/images/a6.jpg">
                                <div class="m-t-xs font-bold">射鸡师</div>
                            </div>
                        </div>
                        <div class="col-sm-8">
