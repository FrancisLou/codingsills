                        ...
                        <div class="file-box">
                            <div class="file">
                                <a href="file_manager.html#">
                                    ...
                                    <div class="image">
                                        <img alt="image" class="img-responsive" src="${ctx}/static/images/p1.jpg">
                                    </div>
                                    <div class="file-name">
                                        Italy street.jpg
                                        <br/>
                        ...
                        <div class="file-box">
                            <div class="file">
                                <a href="file_manager.html#">
                                    ...
                                    <div class="image">
                                        <img alt="image" class="img-responsive" src="${ctx}/static/images/p2.jpg">
                                    </div>
                                    <div class="file-name">
                                        My feel.png
                                        <br/>
                        ...
                        <div class="file-box">
                            <div class="file">
                                <a href="file_manager.html#">
                                    ...
                                    <div class="image">
                                        <img alt="image" class="img-responsive" src="${ctx}/static/images/p3.jpg">
                                    </div>
                                    <div class="file-name">
                                        Document_2014.doc
                                        <br/>
