                ...
                <div class="ibox float-e-margins">
                    ...
                    <div>
                        <div class="ibox-content no-padding border-left-right">
                            <img alt="image" class="img-responsive" src="${ctx}/static/images/profile_big.jpg">
                        </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="${ctx}/pages/view/profile.jsp#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="${ctx}/pages/view/profile.jsp#">选项1</a>
                                </li>
                                <li><a href="${ctx}/pages/view/profile.jsp#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
