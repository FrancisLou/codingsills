        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="${ctx}/static/images/a1.jpg">
                        </a>
                    ...
                    <div class="social-footer">
                        ...
                        <div class="social-comment">
                            <a href="" class="pull-left">
                                <img alt="image" src="${ctx}/static/images/a2.jpg">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                            尤小右
                        ...
                        <div class="social-comment">
                            <a href="" class="pull-left">
                                <img alt="image" src="${ctx}/static/images/a3.jpg">
                            </a>
                            <div class="media-body">
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="${ctx}/static/images/a6.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                        尤小右
                    ...
                    <div class="social-body">
                        ...
                        <img src="${ctx}/static/images/p1.jpg" class="img-responsive">
                        <div class="btn-group">
                            <button class="btn btn-white btn-xs"><i class="fa fa-thumbs-up"></i> 赞</button>
                            <button class="btn btn-white btn-xs"><i class="fa fa-comments"></i> 评论</button>
                            <button class="btn btn-white btn-xs"><i class="fa fa-share"></i> 分享</button>
                    ...
                    <div class="social-footer">
                        ...
                        <div class="social-comment">
                            <a href="" class="pull-left">
                                <img alt="image" src="${ctx}/static/images/a8.jpg">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                            尤小右
                ...
                <div class="social-feed-box">
                    ...
                    <div class="social-avatar">
                        <a href="" class="pull-left">
                            <img alt="image" src="${ctx}/static/images/a4.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                        尤小右
            ...
            <div class="col-sm-6">
                ...
                <div class="social-feed-separated">
                    ...
                    <div class="social-avatar">
                        <a href="">
                            <img alt="image" src="${ctx}/static/images/a5.jpg">
                        </a>
                    </div>
                    ...
                    <div class="social-feed-box">
                        ...
                        <div class="social-body">
                            ...
                            <img src="${ctx}/static/images/p2.jpg" class="img-responsive">
                            <div class="btn-group">
                                <button class="btn btn-white btn-xs"><i class="fa fa-thumbs-up"></i> 赞</button>
                                <button class="btn btn-white btn-xs"><i class="fa fa-comments"></i> 评论</button>
                                <button class="btn btn-white btn-xs"><i class="fa fa-share"></i> 分享</button>
                        ...
                        <div class="social-footer">
                            ...
                            <div class="social-comment">
                                ...
                                <div class="social-comment">
                                    <a href="" class="pull-left">
                                        <img alt="image" src="${ctx}/static/images/a7.jpg">
                                    </a>
                                    <div class="media-body">
                                        <a href="#">
                                                    尤小右
