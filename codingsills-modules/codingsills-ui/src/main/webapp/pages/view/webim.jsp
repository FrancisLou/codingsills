...
<head>
    ...
    <link href="${ctx}/static/plugins/layer/layim/layim.css" rel="stylesheet">
</head>
...
var config = {
    ...
    right: -232,
    api: {
        friend: '${ctx}/static/plugins/layer/layim/data/friend.json', //好友列表接口
        group: '${ctx}/static/plugins/layer/layim/data/group.json', //群组列表接口
        chatlog: '${ctx}/static/plugins/layer/layim/data/chatlog.json', //聊天记录接口
        groups: '${ctx}/static/plugins/layer/layim/data/groups.json', //群组成员接口
        sendurl: '' //发送消息接口
    },
    user: { //当前用户信息
        name: '游客',
    ...
    <script src="${ctx}/static/plugins/layer/layim/layim.js"></script>
</body>
