...
var config = {
    ...
    right: -232,
    api: {
        friend: '../../static/plugins/layer/layim/data/friend.json', //好友列表接口
        group: '../../static/plugins/layer/layim/data/group.json', //群组列表接口
        chatlog: '../../static/plugins/layer/layim/data/chatlog.json', //聊天记录接口
        groups: '../../static/plugins/layer/layim/data/groups.json', //群组成员接口
        sendurl: '' //发送消息接口
    },
    user: { //当前用户信息
        name: '游客',
        face: '../../static/images/a1.jpg'
    },
