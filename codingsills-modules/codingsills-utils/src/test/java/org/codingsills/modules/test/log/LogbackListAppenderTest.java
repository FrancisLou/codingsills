package org.codingsills.modules.test.log;
...
public class LogbackListAppenderTest {
	...
	public void addAndRemoveAppender() {
		...
		// name
		appender.clearLogs();
		appender.addToLogger("org.codingsills.modules.test.log");
		logger.warn(testString);
		assertThat(appender.getFirstLog()).isNotNull();

		appender.clearLogs();
		appender.removeFromLogger("org.codingsills.modules.test.log");
		logger.warn(testString);
		assertThat(appender.getFirstLog()).isNull();
	}
}
